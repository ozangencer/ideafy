...
export const PLATFORM_BRAND_COLORS: Record<AiPlatform, string> = {
  claude: "#cc785c",
  gemini: "#4285f4",
  codex: "#10a37f",
...
function ClaudeIcon({ size, className }: { size: number; className?: string }) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill={PLATFORM_BRAND_COLORS.claude}>
      <path d="M17.3041 3.541h-3.6718l6.696 16.918H24Zm-10.6082 0L0 20.459h3.7442l1.3693-3.5527h7.0052l1.3693 3.5528h3.7442L10.5363 3.5409Zm-.3712 10.2232 2.2914-5.9456 2.2914 5.9456Z" />
    </svg>
  );
}

/** Google Gemini — Four-point sparkle with Google's brand gradient */
function GeminiIcon({ size, className }: { size: number; className?: string }) {
  const gradientId = "ideafy-gemini-gradient";
  return (
...
/** OpenAI Codex — OpenAI hex mark in developer-platform emerald */
function CodexIcon({ size, className }: { size: number; className?: string }) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill={PLATFORM_BRAND_COLORS.codex}>
